...
class TestCourseScheduler(unittest.TestCase):
    ...
    def setUp(self):
        self.courses = {
            1: {"نام کلاس درس": (0, 540, 600), "زمان امتحان": ("1404/10/10", 540, 600)},
            2: {"نام کلاس درس": (0, 610, 670), "زمان امتحان": ("1404/10/11", 540, 600)},
            3: {"نام کلاس درس": (1, 540, 600), "زمان امتحان": ("1404/10/10", 600, 660)},
            4: {"نام کلاس درس": (1, 600, 660), "زمان امتحان": ("1404/10/12", 540, 600)},
        }
